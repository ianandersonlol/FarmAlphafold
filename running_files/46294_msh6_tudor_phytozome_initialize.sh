#!/bin/bash -l
#SBATCH -o /home/icanders/slurm-log/46294_output.txt
#SBATCH -e /home/icanders/slurm-log/46294_errors.txt
...
singularity exec instance://bash ~/46294_msh6_tudor_phytozome.sh
